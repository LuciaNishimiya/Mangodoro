...
export const description = '`<tiempo_trabajo>` `<tiempo_descanso>` `<rondas>` - Inicia el Pomodoro';
export async function execute({ message, prefix, client }) {
    ...
    if (!client.streamClient.connection) return message.reply('No estas conectado a un canal de voz');
